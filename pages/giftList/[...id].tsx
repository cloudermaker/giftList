...
const Family = ({ user, giftList = [] }: { user: TFamilyUser, giftList: TUserGift[] }): JSX.Element => {
    ...
    const addGift = async (): Promise<void> => {
        ...
        const giftToAdd: TUserGift = { id: '0', name: newGiftName, description: '', link: '', ownerUserId: user.id, takenUserId: undefined };
    ...
    return (
        <Layout selectedHeader={EHeader.GiftList}>
            ...
            {!creatingGift && <button onClick={onCreatingGiftButtonClick}>Add new gift</button>}
