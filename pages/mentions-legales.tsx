            ...
            <div className="max-w-3xl mx-auto py-8">
                ...
                <section className="mb-8">
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed">
                        Le site <strong>malistedecadeaux.fr</strong> est un service gratuit édité à titre personnel (PLR). Pour
                        toute question, utilisez la{' '}
                ...
                <section className="mb-8">
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed">
                        ...
                        ). Les données sont stockées sur <strong>Neon</strong> (base de données PostgreSQL hébergée dans
                        l&apos;Union européenne).
                    </p>
                </section>
                ...
                <section className="mb-8">
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed mb-2">
                        Le service est fourni gratuitement, sans garantie de disponibilité ni d&apos;absence d&apos;erreur. Chaque
                        groupe est accessible à toute personne qui en connaît le nom : n&apos;y déposez aucune information
                        sensible.
                    </p>
                    <p className="text-sm text-gray-700 leading-relaxed">
                ...
                <section className="mb-8">
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed">
                        Voir notre{' '}
                        <Link href="/confidentialite" className="text-bleuNoel hover:underline">
