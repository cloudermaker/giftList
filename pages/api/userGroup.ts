...
import { getUserGroups, getGroupUsers, addUserToGroup, removeUserFromGroup, updateUserRole } from '../../lib/db/userGroupManager';
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    try {
        ...
        if (req.method === 'POST') {
            ...
            const membership = await addUserToGroup(userId, groupId, (role as Role) || 'MEMBER');
