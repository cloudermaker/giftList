            ...
            <div>
                ...
                <section className="home-section" style={{ margin: 0, padding: 0, textAlign: 'left' }}>
                    ...
                    <div className="item">
                        ...
                        <p>
                            Oui, notre plateforme de gestion de listes de cadeaux est entièrement gratuite. Aucun abonnement,
                    ...
                    <div className="item">
                        ...
                        <p>
                            Absolument ! Notre outil est parfait pour organiser tous vos échanges de cadeaux : Noël,
                            anniversaires, fêtes des mères, mariages, et toute occasion spéciale.
                        </p>
                    </div>
                    ...
                    <div className="item">
                        ...
                        <p>
                            ...
                            ce lien par SMS, WhatsApp ou email : tes proches n&apos;auront plus qu&apos;à saisir leur prénom pour
                            rejoindre le groupe, sans se souvenir du nom exact.
                        </p>
                    </div>
                    ...
                    <div className="item">
                        ...
                        <p className="mt-2">
                            Pour <strong>supprimer</strong> un utilisateur, il faut être administrateur. Si tu as un souci,
                            n&apos;hésite pas à nous
